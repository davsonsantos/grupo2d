                ...
                <div class="c-block" id="basic">
                    <div class="form-group">
                        ...
                        <select class="form-control validate[required]" id="cat_projeto_id" name="cat_projeto_id">
                            ...
                            <option <?php if($dados->cat_projeto_id == $c->cat_projeto_id) echo "selected"; ?> value="<?=$c->cat_projeto_id?>"><?=$c->cat_projeto_descricao?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
	                ...
	                <div class="fileupload fileupload-new" data-provides="fileupload">
	                    ...
	                    <div>
	                        <span class="btn btn-file btn-sm btn-gr-gray">
	                            ...
	                            <input type="file" name="logo" id="logo" class="validate[required]"/>
	                        </span>
